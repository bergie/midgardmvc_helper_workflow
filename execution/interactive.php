 ...
 * @package midgardmvc_helper_workflow
 */
class midgardmvc_helper_workflow_execution_interactive extends ezcWorkflowExecution
{
    /**
     * @var midgardmvc_helper_workflow_execution
     */
    ...
    private function delete_execution(midgardmvc_helper_workflow_execution $execution)
    {
        $exec_qb = new midgard_query_builder('midgardmvc_helper_workflow_execution');
    ...
    private function delete_states(midgardmvc_helper_workflow_execution $execution)
    {
        $qb = new midgard_query_builder('midgardmvc_helper_workflow_execution_state');
